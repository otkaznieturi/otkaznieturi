...
class ChildAgeSetter extends Component {
  constructor(props) {
    super(props)
    let data = props.child_ages.split(',')
  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handle.bind(this)}>
        ...
        <FormControl id="country" componentClass="select" placeholder="select" defaultValue={values.country}>
          ...
          <optgroup label="Остальные">
            ...
            <option value="Кабо-Верде">Верде</option>
            ...
            <option value="Коста-Рика">Рика</option>
        ...
        <FormControl id="travel_agent" componentClass="select" placeholder="select" defaultValue={values.travel_agent}>
          <optgroup label="Популярные">
